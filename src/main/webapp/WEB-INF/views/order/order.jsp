	  			...
	  			<div class="panel-body">
	  				<h3>주문자 정보</h3>
						...
						<div class="form-group">
								...
								<input type="text" id="sample2_postcode" name="mem_zipcode" value="${sessionScope.loginStatus.mem_zipcode}" class="form-control" 
								...
								<input type="text" id="sample2_detailAddress" name="mem_addr_d" value="${sessionScope.loginStatus.mem_addr_d}" class="form-control" 
						...
						<div class="form-group">
								...
								<input type="text" id="sample2_postcode" name="odr_zipcode" value="${sessionScope.loginStatus.mem_zipcode}" class="form-control" 
									style="max-width: 510px; width:calc(100% - 128px); margin-right: 5px; display: inline-block;" placeholder="우편번호" readonly>
								<input type="button" onclick="sample2_execDaumPostcode()" id="btn_postCode" class="btn btn-default" value="우편번호 찾기"><br>
						...
						<div class="form-group">
								<label for="inputMobile">* 휴대폰 번호</label> <input type="tel"
									value="${sessionScope.loginStatus.mem_phone}" class="form-control" id="odr_phone" name="odr_phone"
									placeholder="휴대폰 번호를 입력해 주세요" style="max-width: 630px;">
...
<script>
	...
	$(document).ready(function(){
		...
		$("#btn_cancle").on("click", function(){
			...
			var result = confirm("구매가 취소되었습니다.");
			if(result){
				location.href="/"; 
			} else{}
		});
