...
<script>
		// 3) 상품후기목록 데이타 출력작업
		var printReveiwData = function(reviewData, reviewTarget, reviewTemplate){
...
<div class="row">
  ...
  var showReviewList = function(curPage){
   ...
   $.getJSON(url, function(data){
      //1)상품후기목록 출력
      printReveiwData(data.list, $("#reviewListView"), $("#reviewTemplate"));
      //2)페이징출력
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      $("#reviewListView").on("click", ".btn-edit", function(){
        ...
        var rv_num, mem_id, pdt_num, rv_content, rv_socre, rv_date_reg;
        ...
        rv_socre = $(this).parents("ul.list-group").find("li[data-rv_score]").attr("data-rv_score");
        rv_date_reg = $(this).parents("ul.list-group").find("li[data-rv_date_reg]").attr("data-rv_date_reg");
        
        console.log(rv_socre);
