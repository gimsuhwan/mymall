...
public class FileUploadUtils {
	...
	public static void deleteFile(String uploadPath, String fileName) {
		...
		// 2021/04/14/s_ad51919e-1e31-4661-ba70-1edfbd96aa35_프로그래밍언어활용5.PNG
		
		//  날짜경로+ UUID_fileName
		String front = fileName.substring(0, 11); 	// 날짜 경로  2021/04/14/
		String end = fileName.substring(13); 		// UUID_fileName
		String origin = front + end; // 2021/04/14/ad51919e-1e31-4661-ba70-1edfbd96aa35_프로그래밍언어활용5.PNG
