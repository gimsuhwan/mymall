    ...
    public JSONObject getChartData() {// json구조를 나타내는 클래스
      ...
      //테이블행에 컬럼 추가 [{"label" : "상품명"}, {"type" : "string" }, {"label" : "금액"}, {"type" : "number"}]
        ...
        for (CartDTO dto : items) { //items에 저장된 값을 dto로 반복문을 돌려서 하나씩 저장한다.
            ...
            body.add(cell); //레코드 1개 추가.  [ {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}]
        ...
        {"rows" : [ {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}, {"c" :  [{"v" : "전자제품1"}, {"v" : 15000}]}]}
        */
